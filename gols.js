...
// Função para renderizar o ranking de gols (ordenado por gols)
function renderGoalRanking() {
    ...
    players.forEach(player => {
        ...
        row.dataset.goals = player.goals;
        row.innerHTML = `
            <td>${player.name}</td>
            <td>${player.goals}</td> <!-- Exibe apenas os gols -->
            <td>
...
function addPlayer() {
    ...
    renderGoalRanking(); // Renderiza o ranking de gols
...
function removePlayer(playerName) {
    ...
    renderGoalRanking(); // Renderiza o ranking de gols após a remoção
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (selectors.containers.playerList) {
        // Página de Ranking de Gols
        renderGoalRanking(); // Chama a função para renderizar o ranking de gols
    }
});
